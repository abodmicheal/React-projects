...
<li><h1>Netflix UI Web App</h1>
   <p><h3>Tools Used</h3><li>React(No Hooks)</li><li>Firebase(Hosting)</li><li>TMDB API</li><li>POSTMAN API CLIENT(Get Movies From API)</li> <li>Css</li><li>BEM</li><li>Axios JS</li></P>
